...
import com.inducesmile.androidpayexample.volley.AppController;
import com.inducesmile.androidpayexample.volley.Config_URL;
...
public class signup extends Activity {
    ...
    private void registerUser(final String name, final String email,
                              final String password, final String phone,final String location) {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (!error) {
                        ...
                        db.addUser(name, email,phone,location, uid, created_at);
