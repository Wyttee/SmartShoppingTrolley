...
public class PayPalCheckoutActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn = (Button)findViewById(R.id.cash_button);
        btnccv = (Button)findViewById(R.id.btnccv);
    ...
    public void onClick(View v) {
        ...
        if (v.getId() == R.id.cash_button) {
            Intent intent = new Intent(PayPalCheckoutActivity.this, thankyou.class);
            startActivity(intent);
        }
        else if(v.getId() == R.id.btnccv){
            Intent intent = new Intent(PayPalCheckoutActivity.this, ccv.class);
            startActivity(intent);
